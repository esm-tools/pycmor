...
# rm -f /work/ab0246/a270092/software/pycmor/tools/sanity_check/reports/cli38_test06_html/assets/maps/*.png
...
python tools/sanity_check/build_maps.py \
    --jsonl tools/sanity_check/reports/cli38_test06.jsonl \
    --out-dir tools/sanity_check/reports/cli38_test06_html \
    --parallel 12
