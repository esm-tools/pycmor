...
def find_subcommands():
    """
    Finds CLI Subcommands for installed pycmor plugins
    """
    discovered_subcommands = {
        ...
        for entry_point in pkg_resources.iter_entry_points("pycmor.cli_subcommands")
    }
    return discovered_subcommands


@click_loguru.logging_options
@click.group(name="pycmor", help="PyMOR - Makes CMOR Simple")
